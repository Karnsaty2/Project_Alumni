  ...
  return (
    <div className='h-20 bg-primary flex items-center px-5 justify-between fixed top-0 w-full shadow-lg z-10'>
      ...
      <div className='flex items-center gap-2'>
        <Link to='/login' className='py-2 px-4 rounded-md font-semibold border-2  text-white hover:bg-white hover:border-transparent hover:text-primary transition duration-500'>LOG IN</Link>
        <Link to='/login' className='bg-white py-2 px-4 rounded-md border-2 border-transparent text-primary font-semibold hover:border-white hover:bg-transparent hover:text-white  transition duration-500'>SIGN UP</Link>
      </div>
    </div>
  )
}
