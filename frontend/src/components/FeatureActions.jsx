...
const FeatureActions = () => {
  return (
    <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
      <button className="flex-1 py-4 px-6 bg-yellow-100 border border-yellow-400 rounded-lg flex flex-col items-center justify-center hover:bg-yellow-200">
      ...
      <button className="flex-1 py-4 px-6 bg-blue-100 border border-blue-400 rounded-lg flex flex-col items-center justify-center hover:bg-blue-200">
        <div className="flex gap-4">
